...
class IndexView(View):
    ...
    def get(self, request):
        ...
        user = request.user
        cart_count = 0
        # hash格式： key field value filed value : cart_23 2 3 3 5(23号用户添加2号商品3件，3号商品5件）
...
class DetailView(View):
    ...
    def get(self, request, goods_id):
        ...
        context = {
            'sku': sku,                              # 商品信息
            'types': types,                          # 种类信息
            'sku_order': sku_order,                  # 商品订单评论信息
            'new_skus': new_skus,                    # 新品信息
            'same_spu_skus': same_spu_skus,          # 同SPU相关商品
            'cart_count': cart_count                 # 购物车订单数量
