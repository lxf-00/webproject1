...
from tinymce.models import HTMLField    #  使用富文本编辑器
...
class GoodsSKU(BaseModel):
    """商品SKU模型类（stock keeping unit 库存量单位）"""
    status_choices = (
        (0, '下线'),
        (1, '上线'),
    )
